  ...
  return (
    <>
      <header className="header">
        <div className="logo">Assessmentr</div>
      </header>
            ...
            {activeTab === 'signin' && (
              <div className="auth-form active">
                <div className="form-header">
                  ...
                  <p className="form-subtitle">Enter your credentials to access your precision testing suite.</p>
                </div>
            ...
            {activeTab === 'signup' && (
              <div className="auth-form active">
                <div className="form-header">
                  ...
                  <p className="form-subtitle">Sign up to begin your journey with our platform.</p>
                </div>
      ...
      <footer className="footer">
        <div>© 2024 ASSESSMENTR. PRECISION VOICE INTELLIGENCE.</div>
